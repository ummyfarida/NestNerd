            ...
            <Card className="bg-dark text-white" style={{ borderRadius: '1rem' }}>
              <Card.Body className="p-5 text-center">
                ...
                <div className="mb-md-5 mt-md-4 pb-5">
                  ...
                  <Form>
                    <Form.Group className="form-white mb-4" controlId="typeEmailX">
                      <Form.Control type="email" className="form-control form-control-lg" placeholder="Email" />
                    </Form.Group>

                    <Form.Group className="form-white mb-4" controlId="typePasswordX">
                    ...
                    <div className="d-flex justify-content-center text-center mt-4 pt-1">
                      <a href="#!" className="text-white"><FaFacebookF size={28} /></a>
                      <a href="#!" className="text-white mx-4 px-2"><FaTwitter size={28} /></a>
                      <a href="#!" className="text-white"><FaGoogle size={28} /></a>
                    </div>
                  </Form>
